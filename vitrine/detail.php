<?php
  ...
  $id= $_GET['id'];
  $malla = $connexion->prepare("SELECT * FROM personnages WHERE id_personnage = $id");
  $malla->execute();
  $desing = $malla->fetch();
                  ...
                  <section id="about" class="about">
                    <div class="container" data-aos="fade-up">
                      ...
                      <div class="section-title">
                        <h2>A propos de <?php echo $desing['nom_complet'];?></h2>
                      </div>
                      <!-- ======= Team Section ======= -->
                        ...
                        <div class="container" data-aos="fade-up">
                              ...
                              <div class="col-md-12">
                                  ...
                                  <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
                                        <div class="pic">
                                          <img src="image/<?= $desing['nom_image'];?>" class="img-fluid" alt="">
                                        </div>
                                  </div>

                                  <div class="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
                                        <div class="member-info">
                                          <h4><?php echo $desing['historique'];?></h4>
                                        </div>
                                  </div>
                              </div>
